...
function Register() {
  ...
  return (
   ...
   <div className="bg-white border-2 border-solid rounded-md border-green-800 w-[500px] h-fit flex flex-col justify-evenly gap-9 pt-16 pb-16 pl-16 pr-16 items-center p-4 max-sm:w-full ml-[-650px]">
